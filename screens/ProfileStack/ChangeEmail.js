  ...
  onSubmit = () => {
    ...
    firebase
      ...
      .then(() => {
        ...
        firebase
          .auth()
          .currentUser.updateEmail(this.state.email.toLowerCase())
          .then(() => {
            firebase
              .firestore()
              .collection("users")
        ...
        {this.state.submitted ? (
          ...
          <>
            ...
            <ButtonBlock
              ...
              disabled={this.state.emailTaken || this.state.email.length == 0}
              disabledStyles={{ opacity: 0.3, backgroundColor: colors.orange }}
            >
              <>
                <HelperText
                  visible={this.state.emailBlur && this.state.emailTaken}
                ...
                />
                <HelperText
                  visible={this.state.emailInvalid}
