...
//import { Dimensions, Share, TouchableOpacity, StyleSheet } from 'react-native';
...
class GameScreen extends React.Component {
  ...
  render() {
    ...
    if (this.state.currentUserProfile != null && this.state.currentUserProfile.calendar.length > 0) {
      //////////////////////////////
        ...
        <>
          ...
          >
            <ScrollView style={{ width: "100%" }}>
              {this.state.currentUserProfile.calendar.map((game, index) => {
                return (
                  <GamePreview
                    key={index}
                    game={game}
