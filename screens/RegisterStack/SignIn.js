    ...
    return (
      <SafeAreaView style={{flex:1, backgroundColor:colors.dBlue}}>
        ...
        <Block center middle width={width} style={{}}>
          ...
          <Button uppercase={false} mode="text" onPress={this.toSignUp} dark={true} style={styles.createButton} theme={{colors:{primary:colors.lGreen},fonts:{medium:this.props.theme.fonts.regular}}}>
              Sign Up
          </Button>
        </Block>
      </SafeAreaView>
