                ...
                <Block style={{flexDirection:'row-reverse',marginBottom:8}}>
                    {
                        ...
                        ? <Block style={{marginTop:"auto"}} >
                            <ProfilePic size={30} proPicUrl={this.props.message.sender.proPicUrl}/>
                        </Block>
                        : null
                    }
                    <Block flex column style={{borderColor:colors.white,paddingRight: 8}}>
                        {
                            ...
                            ? <Text style={{color:colors.grey,marginLeft:'auto',marginRight:(!(this.props.messageBelow == undefined || this.props.messageBelow.senderId != this.props.message.senderId) ? 34 : 0),paddingBottom:4}}>{`@${this.props.message.sender.username}`}</Text>
                            : null
                        }
                    ...
                    <Block flex column style={{borderColor:colors.white,paddingLeft:8}}>
                        {
                            this.props.messageAbove == undefined || this.props.messageAbove.senderId != this.props.message.senderId
                            ? <TouchableOpacity style={{marginTop:"auto"}} onPress={() => this.props.navigation.navigate('UserProfile', {userId:this.props.message.senderId})}>
                            <Text style={{color:colors.grey,marginRight:'auto',marginLeft:(!(this.props.messageBelow == undefined || this.props.messageBelow.senderId != this.props.message.senderId) ? 34 : 0),paddingBottom:4}}>{`@${this.props.message.sender.username}`}</Text>
                            </TouchableOpacity>
                            : null
                        }
