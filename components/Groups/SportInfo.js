  ...
  render(){
    ...
    <Block row middle style={styles.container}>
        <Block flex row middle>
            <Avatar.Image
                size={24}
                source={sports[this.props.sport]}
            />
            <Block flex row style={{marginLeft:12,justifyContent:'space-between'}}>
                <Text style={{color:"#FFF"}}>{this.props.sport[0].toUpperCase() + this.props.sport.substring(1)}</Text>
