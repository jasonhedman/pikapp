...
class GameResult extends React.Component {
  ...
  render(){
    return (
      <Block column style={{}}>
        <Subheading style={{textAlign:'center',color:"white"}}>{`${this.props.game.intensity} ${this.props.game.sport[0].toUpperCase() + this.props.game.sport.substring(1)}`}</Subheading>
        <Block row>
