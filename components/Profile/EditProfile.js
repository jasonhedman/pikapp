        ...
        <>
          ...
          >
            <Block center middle style={{width,backgroundColor:colors.dBlue,borderTopWidth:2,borderTopColor:colors.orange,marginTop:'auto', paddingBottom:32, paddingTop:16}}>
              <ButtonBlock text='Choose New Image' onPress={this.pickImage} uppercase={false}>
                <HelperText
                  type="error"
              ...
              <Block middle center style={styles.buttonBlock}>
                <Button mode="text" dark={true} style={styles.createButton} onPress={this.removeImage} theme={{colors:{primary:colors.orange},fonts:{medium:this.props.theme.fonts.regular}}} uppercase={false}>
                    Delete Image
                </Button>
              </Block>
            </Block>
          ...
          <Block middle dstyle={{backgroundColor:colors.dBlue,borderColor:colors.orange,borderWidth:2,borderRadius:8, padding: 16}}>
