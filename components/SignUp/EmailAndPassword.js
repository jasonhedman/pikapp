    ...
    return (
      <Form>
        ...
        >
          <HelperText
            visible={
              (!this.state.email.includes("@") || this.state.emailTaken) &&
        ...
        >
          <HelperText
            visible={
              !(this.state.password.length >= 8) && this.state.passwordBlur
            }
        ...
        >
          <HelperText
            visible={this.state.matchError && this.state.passwordConfirmBlur}
